...
public class BluetoothManager : MonoBehaviour
{
    ...
    public static Action<string> OnNewDevice;
    public static Action<string> OnDataRead;
    ...
    void CreateDeviceInfo(string macText)
    {
        OnNewDevice?.Invoke(macText);

        GameObject obj = Instantiate(deviceMACText, devicesListContainer.transform);
        //GameObject newDevice = deviceMACText;
        obj.GetComponentInChildren<Text>().text = macText;
        obj.GetComponent<Button>().onClick.AddListener(() => ConectionLineClick(obj));
    ...
    public void StartConnection(string macAddress)
    {
        ...
        Debug.Log("Start connection: " + macAddress.ToUpper());
    ...
    public void StartConnection()
    {
        ...
        Debug.Log("Start connection: " + deviceAdd.text.ToString().ToUpper());
    }
    ...
    public void ConectionLineClick(GameObject obj)
    {
        //deviceAdd.text = obj.GetComponentInChildren<Text>().text;
        deviceAdd.text = obj.GetComponentInChildren<Text>().text.Split('+')[0];
    }
    ...
    public void ConnectionStatus(string status)
    {
        ...
        receivedData.text = "Connection Status: " + status + "\n";
